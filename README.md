...
[![GitHub Release](https://img.shields.io/github/v/release/mathiasHillmann/go-kafka)](https://github.com/mathiasHillmann/go-kafka/releases)
[![Go Reference](https://pkg.go.dev/badge/github.com/mathiasHillmann/go-kafka.svg)](https://pkg.go.dev/github.com/mathiasHillmann/go-kafka)
[![go.mod](https://img.shields.io/github/go-mod/go-version/mathiasHillmann/go-kafka)](go.mod)
[![LICENSE](https://img.shields.io/github/license/mathiasHillmann/go-kafka)](LICENSE)
[![Build Status](https://img.shields.io/github/workflow/status/mathiasHillmann/go-kafka/build)](https://github.com/mathiasHillmann/go-kafka/actions?query=workflow%3Abuild+branch%3Amain)
[![Go Report Card](https://goreportcard.com/badge/github.com/mathiasHillmann/go-kafka)](https://goreportcard.com/report/github.com/mathiasHillmann/go-kafka)
[![Codecov](https://codecov.io/gh/mathiasHillmann/go-kafka/branch/main/graph/badge.svg)](https://codecov.io/gh/mathiasHillmann/go-kafka)
...
1. Replace all occurences of `mathiasHillmann/go-kafka` to `your_org/repo_name` in all files.
1. Replace all occurences of `go-kafka` to `repo_name` in [Dockerfile](Dockerfile).
